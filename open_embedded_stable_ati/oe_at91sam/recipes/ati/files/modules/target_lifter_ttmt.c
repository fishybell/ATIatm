//---------------------------------------------------------------------------
// target_lifter_ttmt.c
// Derived from target_lifter_armor.c this controls the solenoids for the
// pnumatics.
//---------------------------------------------------------------------------
...
#define TARGET_NAME  "ttmt sit lifter"
#define LIFTER_TYPE  "ttmt sit"

#define TIMEOUT_IN_SECONDS  2
#define BOB_TIMEOUT_IN_MILLISECONDS		250
#define SENSOR_TIMEOUT_LEAVE_IN_MILLISECONDS	4700
#define SENSOR_TIMEOUT_ARRIVE_IN_MILLISECONDS	5000
