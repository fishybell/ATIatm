...
#define	OUTPUT_CHARGING_RELAY_ACTIVE_STATE 		ACTIVE_LOW
#define	OUTPUT_CHARGING_RELAY_INACTIVE_STATE 	ACTIVE_HIGH
...
#define	OUTPUT_THERMAL 				AT91_PIN_PA5 // J9-5 Lifter board
