...
//not needed #define	INPUT_WAKEUP_BUTTON 				AT91_PIN_PB25
...
#define	OUTPUT_MOVER_MOTOR_FWD_POS_PWM 				AT91_PIN_PB3
#define	OUTPUT_MOVER_MOTOR_REV_POS_PWM 				AT91_PIN_PB19
