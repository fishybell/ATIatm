...
DEPENDS = "virtual/libsdl xsp zlib libpng jpeg freetype fontconfig alsa-lib lzo ncurses libxv virtual/libx11 \
           ${@base_conditional('ENTERPRISE_DISTRO', '1', '', 'libmad liba52 lame', d)} live555"
...
#--with-extraincdir=${WORKDIR}/../live555-20101020-r0/live/liveMedia/include:${WORKDIR}/../live555-20101020-r0/live/groupsock/include:${WORKDIR}/../live555-20101020-r0/live/BasicUsageEnvironment/include:${WORKDIR}/../live555-20101020-r0/live/UsageEnvironment/include
#--with-extralibdir=${WORKDIR}/../live555-20101020-r0/live/liveMedia:${WORKDIR}/../live555-20101020-r0/live/groupsock:${WORKDIR}/../live555-20101020-r0/live/BasicUsageEnvironment:${WORKDIR}/../live555-20101020-r0/live/UsageEnvironment:${WORKDIR}/../live555-20101020-r0/live/mediaServer
#--enable-live

EXTRA_OECONF = " \
	--with-extraincdir=${WORKDIR}/../live555-20101020-r0/live \
	--disable-nemesi \
        --prefix=/usr \
	--mandir=${mandir} \
        --target=${TARGET_SYS} \
